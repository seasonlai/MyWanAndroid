package com.example.wellhope.mywanandroid.utils;
...
//            Toast.makeText(activity,"alpha"+statusBarAlpha*1.0f/255,Toast.LENGTH_LONG).show();
//            fakeTranslucentView.setAlpha(statusBarAlpha*1.0f/255);
        } else {
